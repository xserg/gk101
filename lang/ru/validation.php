...
return [
    ...
    */
    ...
    'attributes' => [
      ...
      'institutions' => 'Учереждения',
      'name' => 'Имя',
      'lastname' => 'Фамилия',
      'fathername' => 'Отчество',
      'tabel_num' => 'Табельный номер',
      'division' => 'Подразделение',
      'role_id' => 'Роль',
      'division_group' => 'Группа',
      'position' => 'Должность',
      'year' => 'Год',
      'month' => 'Месяц',
      'head' => 'Руководитель',
      ...
      'fio' => 'ФИО',
      'total' => 'Всего',
      'visit_rate'  => 'Норма посещений',
      'visits'  => 'Принято в итоге',
      'retes_count' => 'Ставок всего',
      'no_worked_rates' => 'Ставок не выработано',
      'pump_account' => 'Счет ОМС',
      'account_hour' => 'Счет в час',
      'max_account_hour' => 'Счет в час максимальный',
      'account_reserve' => 'Резерв роста счета',
      'avg_account_hour' => 'Счет в час средний',
      'polis' => 'Полис',
      'weeks' => 'Срок беременности',
      'snils' => 'СНИЛС',
      'expect_born' => 'Предполагаемая дата родов',
