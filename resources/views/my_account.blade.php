                    ...
                    <div class="card-body backpack-profile-form bold-labels">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                @endphp
                                <label class="required">{{ $label }}</label>
                                <input required class="form-control" type="{{ backpack_authentication_column()==backpack_email_column()?'email':'text' }}" name="{{ $field }}" value="{{ old($field) ? old($field) : $user->$field }}" disabled>
                            </div>
                        </div>
                    </div>
